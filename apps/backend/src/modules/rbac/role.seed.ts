...
export const ROLE_SEEDS: RoleSeedDefinition[] = [
  ...
  },
  {
    ...
    description:
      'Top executive — full system access (same as Super Admin); bypasses permission checks',
    permissions: ALL,
    bypassPermissions: true,
    isSystem: true,
    status: RoleStatus.Active,
  ...
  },
  {
    ...
    description: 'Site supervision, attendance, material issues, and petty cash requests',
    permissions: [
      'project.view',
      'dpr.view',
      'dpr.create',
  ...
  },
  {
    code: 'SALES_MANAGER',
    name: 'Sales Manager',
    description: 'CRM, units, customers, bookings, collections, handover',
    permissions: [
      'crm.view',
      'crm.manage',
      'lead.view',
...
/**
 * System roles allowed to create petty cash requests (site field staff).
 * Approvers (MD / Director / PM / Finance) get `petty_cash.approve` instead.
 * Super Admin retains the full catalog via ALL.
 */
export const PETTY_CASH_REQUEST_CREATOR_ROLE_CODES = [
  'SITE_SUPERVISOR',
  'SITE_ENGINEER',
