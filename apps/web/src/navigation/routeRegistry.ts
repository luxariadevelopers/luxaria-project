...
const APP_ROUTES = [
  ...
  },
  {
    ...
    groupId: 'overview',
    icon: 'reports',
    anyOf: ['dashboard.view', 'analytics.dashboard.view'],
    projectScope: 'none',
  ...
  },
  {
    ...
    groupId: 'analytics',
    icon: 'reports',
    anyOf: ['analytics.company.view'],
    projectScope: 'none',
    breadcrumbSegment: 'executive-summary',
  },
  {
    id: 'project-health',
    path: '/project-health',
    ...
    groupId: 'analytics',
    icon: 'projects',
    anyOf: ['analytics.project.view'],
    projectScope: 'none',
    breadcrumbSegment: 'project-health',
  },
  {
    ...
    groupId: 'analytics',
    icon: 'finance',
    anyOf: ['analytics.financial.view'],
    projectScope: 'none',
    breadcrumbSegment: 'project-profitability',
  },
  {
    ...
    groupId: 'analytics',
    icon: 'finance',
    anyOf: ['analytics.forecast.view'],
    projectScope: 'none',
    breadcrumbSegment: 'cash-flow-forecast',
  },
  {
    id: 'analytics-cost-forecast',
    path: '/cost-forecast',
    title: 'Cost Forecast',
    layout: 'app',
    showInNav: true,
  ...
  },
  {
    ...
    groupId: 'analytics',
    icon: 'sales',
    anyOf: ['analytics.sales.view'],
    projectScope: 'none',
    breadcrumbSegment: 'sales-analytics',
  },
  {
    ...
    groupId: 'analytics',
    icon: 'dpr',
    anyOf: ['analytics.construction.view'],
    projectScope: 'none',
    breadcrumbSegment: 'construction-analytics',
  },
  {
    ...
    groupId: 'analytics',
    icon: 'purchase',
    anyOf: ['analytics.procurement.view'],
    projectScope: 'none',
    breadcrumbSegment: 'procurement-analytics',
  },
  {
    ...
    groupId: 'analytics',
    icon: 'stock',
    anyOf: ['analytics.inventory.view'],
    projectScope: 'none',
    breadcrumbSegment: 'inventory-analytics',
  },
  {
    ...
    groupId: 'analytics',
    icon: 'projects',
    anyOf: ['analytics.contractor.view'],
    projectScope: 'none',
    breadcrumbSegment: 'contractor-analytics',
  },
  {
    ...
    anyOf: ['analytics.financial.view'],
    projectScope: 'none',
    breadcrumbSegment: 'financial-analytics',
  },
  {
    id: 'risk-alerts',
    path: '/risk-alerts',
  ...
  },
  {
    ...
    anyOf: ['analytics.dashboard.view'],
    projectScope: 'none',
    breadcrumbSegment: 'kpi-drilldown',
  },
  {
    ...
    groupId: 'analytics',
    icon: 'reports',
    anyOf: ['analytics.export', 'analytics.dashboard.view'],
    projectScope: 'none',
    breadcrumbSegment: 'analytics-reports',
  },
  {
