...
export type UpdateWorkMeasurementInput = Partial<CreateWorkMeasurementInput>;

export type RejectWorkMeasurementInput = {
  reason: string;
};

export type VerifyWorkMeasurementInput = {
  notes?: string | null;
};

export type CertifyWorkMeasurementInput = {
  notes?: string | null;
};
...
export type WorkMeasurementFilterState = {
  status: WorkMeasurementStatus | '';
  contractorId: string;
  boqItemId: string;
  fromDate: string;
