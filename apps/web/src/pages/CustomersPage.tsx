...
/**
 * Customer master list (Micro Phase 099).
 * APIs: list/create/update/verify-kyc/activate/deactivate.
 * Aadhaar is masked to last-4 reference in the table.
 */
  ...
  return (
    <Stack spacing={2}>
      <Typography color="text.secondary">
        Customer master — search, KYC review and activation. Aadhaar references
        are masked; full digits require customer.manage on the detail screen.
      </Typography>
      ...
      <VerifyKycDialog
        ...
        customer={
          kycTarget
            ? { id: kycTarget.row.id, fullName: kycTarget.row.fullName }
            : null
        }
